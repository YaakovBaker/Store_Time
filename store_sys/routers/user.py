...
#POST User Methods
@router.post("/user/", response_model=schemas.UserShow, status_code=status.HTTP_201_CREATED)
...
#GET User Methods
@router.get("/user/{user_id}", response_model=schemas.UserShow)
...
#UPDATE User Methods
@router.put("/user/update/{user_id}", status_code=status.HTTP_202_ACCEPTED)
